...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-color-primary p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 dark:bg-color-dark",
  {
    variants: {
      side: {
        ...
        right:
          "inset-y-0 right-0 h-full w-2/3 data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-sm shadow-left shadow-color-accent",
      },
    },
    defaultVariants: {
      side: "right",
